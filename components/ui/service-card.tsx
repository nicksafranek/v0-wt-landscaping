...
export function ServiceCard({ service, index }: ServiceCardProps) {
  ...
  return (
    <Link
      ...
      className="block h-full focus:outline-none focus-visible:ring-2 focus-visible:ring-orange focus-visible:ring-offset-2 rounded-2xl"
    >
      <motion.article
        ...
        className="group relative bg-card rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer border border-transparent hover:border-orange/30 h-full flex flex-col hover:-translate-y-2"
      >
